...
const CANADA = [
  {
    ...
    from:0, interested:4100, video:true, vlen:"0:10",
    art:{a:"#0A9179", b:"#F2A93B", glyph:"✧"},
  ...
  },
  {
    ...
    from:0, interested:6300, video:true, vlen:"0:12",
    art:{a:"#6B3FD4", b:"#0A9179", glyph:"◈"},
  ...
  },
  {
    ...
    from:0, interested:8900, video:true, vlen:"0:12",
    art:{a:"#0A9179", b:"#F2A93B", glyph:"◕"},
...
/* ---------- platform-wide buyer monitor ----------
   Who bought what, across every organizer. The owner is merchant of record,
   so this is their view of the whole order book.                          */
PLATFORM.buyers = [
  {num:"NB-49004", name:"Ananya Raghavan",  email:"ananya.r@gmail.com",      phone:"+1 416 ••• 4471",
   eventId:"food-fest",     org:"Toronto Eats Collective", city:"Toronto",   qty:2, tier:"General Entry",
   face:30,   fees:4.23, method:"Visa •••• 4242",      mins:2,   status:"paid"},
  {num:"NB-49003", name:"Harpreet Sandhu",  email:"h.sandhu@outlook.com",    phone:"+1 647 ••• 1180",
   eventId:"garba-night",   org:"Rangeela Events",         city:"Toronto",   qty:4, tier:"Family Pack (4)",
   face:80,   fees:9.69, method:"Apple Pay",            mins:6,   status:"paid"},
  {num:"NB-49002", name:"Chloé Tremblay",   email:"chloe.t@videotron.ca",    phone:"+1 514 ••• 9902",
   eventId:"old-port-lumiere", org:"Lumière Collectif",    city:"Montreal",  qty:3, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",     mins:9,   status:"paid"},
  {num:"NB-49001", name:"Marcus Osei",      email:"m.osei@protonmail.com",   phone:"+1 437 ••• 6620",
   eventId:"afrobeats",     org:"Lagos Nights TO",         city:"Toronto",   qty:2, tier:"General Admission",
   face:70,   fees:6.43, method:"Mastercard •••• 5533",  mins:14,  status:"checkedin"},
  {num:"NB-49000", name:"Zainab Khan",      email:"zainab.k@gmail.com",      phone:"+1 905 ••• 3318",
   eventId:"food-fest",     org:"Toronto Eats Collective", city:"Toronto",   qty:1, tier:"Golden Fork (VIP)",
   face:79,   fees:5.64, method:"Visa •••• 8812",        mins:21,  status:"paid"},
  {num:"NB-48999", name:"Dev Sharma",       email:"dev.sharma@shaw.ca",      phone:"+1 604 ••• 7745",
   eventId:"warehouse-techno", org:"Concrete Sound",       city:"Vancouver", qty:2, tier:"Phase 1",
   face:60,   fees:5.88, method:"Google Pay",            mins:27,  status:"paid"},
  {num:"NB-48998", name:"Émilie Gagnon",    email:"e.gagnon@sympatico.ca",   phone:"+1 438 ••• 2204",
   eventId:"mtl-afterhours",org:"Sous-Sol",                city:"Montreal",  qty:1, tier:"Advance",
   face:28,   fees:2.83, method:"Visa •••• 1907",        mins:34,  status:"paid"},
  {num:"NB-48997", name:"Jasleen Gill",     email:"jasleen.gill@gmail.com",  phone:"+1 778 ••• 5561",
   eventId:"bhangra-park",  org:"Punjabi Arts BC",         city:"Surrey",    qty:6, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",      mins:41,  status:"paid"},
  {num:"NB-48996", name:"Tom Whitfield",    email:"tomw@telus.net",          phone:"+1 403 ••• 8873",
   eventId:"edmonton-folk", org:"River Valley Music",      city:"Edmonton",  qty:2, tier:"Hill Admission",
   face:76,   fees:6.76, method:"Visa •••• 3390",        mins:52,  status:"paid"},
  {num:"NB-48995", name:"Priya Menon",      email:"priya.menon@gmail.com",   phone:"+1 416 ••• 2214",
   eventId:"qawwali-night", org:"Mehfil Collective",       city:"North York",qty:2, tier:"Floor Cushion",
   face:80,   fees:6.98, method:"Apple Pay",             mins:63,  status:"paid"},
  {num:"NB-48994", name:"Dilnaz Tahir",     email:"dilnaz.t@icloud.com",     phone:"+1 289 ••• 4408",
   eventId:"food-fest",     org:"Toronto Eats Collective", city:"Toronto",   qty:3, tier:"General Entry",
   face:45,   fees:6.35, method:"Visa •••• 4242",        mins:74,  status:"checkedin"},
  {num:"NB-48993", name:"Liam O'Connor",    email:"liam.oc@gmail.com",       phone:"+1 902 ••• 1129",
   eventId:"halifax-waterfront", org:"Waterfront Arts",    city:"Halifax",   qty:4, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",      mins:88,  status:"paid"},
  {num:"NB-48992", name:"Sofia Ramírez",    email:"sofia.r@hotmail.com",     phone:"+1 647 ••• 7736",
   eventId:"silent-disco",  org:"Quiet Riot TO",           city:"Toronto",   qty:2, tier:"Pair Pass (2)",
   face:40,   fees:3.49, method:"Mastercard •••• 6641",  mins:97,  status:"paid"},
  {num:"NB-48991", name:"Arjun Bedi",       email:"arjun.bedi@gmail.com",    phone:"+1 403 ••• 9925",
   eventId:"punjabi-mela-yyc", org:"Alberta Punjabi Society", city:"Calgary",qty:5, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",      mins:112, status:"paid"},
  {num:"NB-48990", name:"Grace Lin",        email:"grace.lin@gmail.com",     phone:"+1 778 ••• 3047",
   eventId:"granville-buskers", org:"Island Arts Society", city:"Vancouver", qty:2, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",      mins:126, status:"checkedin"},
  {num:"NB-48989", name:"Nadia Farouk",     email:"n.farouk@gmail.com",      phone:"+1 613 ••• 5580",
   eventId:"nuit-lumiere-ott", org:"Capital Arts Night",   city:"Ottawa",    qty:2, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",      mins:141, status:"paid"},
  {num:"NB-48988", name:"Ravi Krishnan",    email:"ravi.k@rogers.com",       phone:"+1 416 ••• 6693",
   eventId:"cricket-final", org:"GTA Cricket Club",        city:"Toronto",   qty:4, tier:"Table Seat",
   face:112,  fees:10.32,method:"Visa •••• 2276",        mins:158, status:"checkedin"},
  {num:"NB-48912", name:"Sunrise Thapa",    email:"s.thapa@gmail.com",       phone:"+1 647 ••• 8814",
   eventId:"sunrise-yoga",  org:"Sunrise Collective",      city:"Toronto",   qty:1, tier:"Flow + Chai",
   face:18,   fees:2.28, method:"Visa •••• 5501",        mins:181, status:"refunded"},
  {num:"NB-48911", name:"Kwame Boateng",    email:"kwame.b@gmail.com",       phone:"+1 437 ••• 2290",
   eventId:"street-feast",  org:"College St BIA",          city:"Toronto",   qty:2, tier:"Feast Pass",
   face:68,   fees:6.32, method:"Google Pay",            mins:204, status:"paid"},
  {num:"NB-48910", name:"Mei-Ling Chow",    email:"meiling.c@gmail.com",     phone:"+1 604 ••• 4417",
   eventId:"diwali-drive",  org:"Vancouver Desi Arts",     city:"Vancouver", qty:3, tier:"Free RSVP",
   face:0,    fees:0,    method:"Free — no payment",      mins:229, status:"paid"},
  {num:"NB-48909", name:"Simon Beauchamp",  email:"s.beauchamp@gmail.com",   phone:"+1 514 ••• 1163",
   eventId:"mtl-comedy",    org:"Rire Collectif",          city:"Montreal",  qty:2, tier:"Marathon Pass",
   face:52,   fees:5.44, method:"Visa •••• 7729",        mins:248, status:"paid"},
  {num:"NB-48908", name:"Fatima Al-Rashid", email:"fatima.ar@gmail.com",     phone:"+1 905 ••• 9038",
   eventId:"kids-science",  org:"Curious Minds",           city:"North York",qty:1, tier:"Family Pass",
   face:44,   fees:3.71, method:"Mastercard •••• 8890",  mins:271, status:"paid"},
];
/* orders that stream in while the monitor is running */
PLATFORM.incoming = [
  {name:"Noah Fitzgerald", email:"noah.f@gmail.com",     phone:"+1 416 ••• 3320", eventId:"food-fest",
   org:"Toronto Eats Collective", city:"Toronto", qty:2, tier:"Entry + Tasting Pass", face:78, fees:6.58, method:"Apple Pay"},
  {name:"Simran Dhaliwal", email:"simran.d@gmail.com",   phone:"+1 778 ••• 7712", eventId:"bhangra-park",
   org:"Punjabi Arts BC", city:"Surrey", qty:4, tier:"Free RSVP", face:0, fees:0, method:"Free — no payment"},
  {name:"Julien Roy",      email:"julien.roy@gmail.com", phone:"+1 438 ••• 5529", eventId:"old-port-lumiere",
   org:"Lumière Collectif", city:"Montreal", qty:2, tier:"Free RSVP", face:0, fees:0, method:"Free — no payment"},
  {name:"Hannah Weiss",    email:"h.weiss@gmail.com",    phone:"+1 647 ••• 6604", eventId:"silent-disco",
   org:"Quiet Riot TO", city:"Toronto", qty:1, tier:"General Admission", face:24, fees:2.61, method:"Visa •••• 9911"},
  {name:"Bilal Ahmed",     email:"bilal.a@gmail.com",    phone:"+1 403 ••• 2286", eventId:"punjabi-mela-yyc",
   org:"Alberta Punjabi Society", city:"Calgary", qty:6, tier:"Free RSVP", face:0, fees:0, method:"Free — no payment"},
  {name:"Ines Moreau",     email:"ines.m@gmail.com",     phone:"+1 514 ••• 4470", eventId:"mtl-afterhours",
   org:"Sous-Sol", city:"Montreal", qty:2, tier:"Advance", face:56, fees:5.66, method:"Google Pay"},
  {name:"Tyler Nguyen",    email:"tyler.n@gmail.com",    phone:"+1 604 ••• 8823", eventId:"warehouse-techno",
   org:"Concrete Sound", city:"Vancouver", qty:1, tier:"Phase 2", face:45, fees:3.77, method:"Visa •••• 3044"},
